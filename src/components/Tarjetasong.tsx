...
export default function ({song}: Props) {
    ...
    return (
        ...
        <div>
            <div
                onClick={handlerClick} className="flex overflow-hidden flex-row items-center cursor-pointer gap-14 bg-purple-300/90 justify-between rounded-xl transition-all hover:-translate-y-1 hover:bg-violet-500/20 scale-100 duration-150 ease-in outline-2 outline-offset-4 outline-purple-900/70"
            >
                <div>
                    <img
                        src={song.image.url}
